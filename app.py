...
INSTRUMENTAL_TAGS = {
    ...
    "Zither", "Ukulele", "Hammond organ", "Sampler", "Percussion", "Drum kit", 
    ...
    "Clarinet", "Harp", "Bell", "Church bell", "Harmonica", "Accordion", "Bagpipes", 
    "Didgeridoo", "Shofar", "Theremin", "Singing bowl", "Rock music", "Heavy metal", 
    "Punk rock", "Grunge", "Progressive rock", "Rock and roll", "Psychedelic rock", 
    "Reggae", "Country", "Swing music", "Bluegrass", "Funk", "Folk music", 
    "Middle Eastern music", "Disco", "Classical music", "Electronic music", 
    ...
    "Salsa music", "Flamenco", "Blues", "Music for children", "Music of Africa", 
